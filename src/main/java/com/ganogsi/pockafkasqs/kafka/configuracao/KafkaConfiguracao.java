package com.ganogsi.pockafkasqs.kafka.configuracao;
...
public class KafkaConfiguracao {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
        ...
        factory.getContainerProperties().setAckMode(ContainerProperties.AckMode.MANUAL_IMMEDIATE); // Se necessário
